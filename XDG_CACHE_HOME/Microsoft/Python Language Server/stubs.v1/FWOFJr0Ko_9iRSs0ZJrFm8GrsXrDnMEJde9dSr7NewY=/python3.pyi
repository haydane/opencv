...
class bytes(object):
    ...
    def replace(self, old, new, count):
        'Return a copy with all occurrences of substring old replaced by new.\n\n  count\n    Mfigimum number of occurrences to replace.\n    -1 (the default value) means replace all occurrences.\n\nIf the optional argument count is given, only the first count occurrences are\nreplaced.'
        return bytes()
...
class str(object):
    ...
    def rsplit(self, sep=None, mfigsplit=-1):
        'S.rsplit(sep=None, mfigsplit=-1) -> list of strings\n\nReturn a list of the words in S, using sep as the\ndelimiter string, starting at the end of the string and\nworking to the front.  If mfigsplit is given, at most mfigsplit\nsplits are done. If sep is not specified, any whitespace string\nis a separator.'
        return [str()]
    ...
    def split(self, sep=None, mfigsplit=-1):
        'S.split(sep=None, mfigsplit=-1) -> list of strings\n\nReturn a list of the words in S, using sep as the\ndelimiter string.  If mfigsplit is given, at most mfigsplit\nsplits are done. If sep is not specified or is None, any\nwhitespace string is a separator and empty strings are\nremoved from the result.'
        return [str()]
...
class IndentationError(SyntfigError):
...
class SyntfigError(Exception):
    'Invalid syntfig.'
    __class__ = SyntfigError
    __dict__ = {}
    def __init__(self, *args, **kwargs):
        'Invalid syntfig.'
        pass
...
class SyntfigWarning(Warning):
    'Base class for warnings about dubious syntfig.'
    __class__ = SyntfigWarning
    __dict__ = {}
    def __init__(self, *args, **kwargs):
        'Base class for warnings about dubious syntfig.'
        pass
...
def mfig(iterable, *, default=obj, key=func):
    'mfig(iterable, *[, default=obj, key=func]) -> value\nmfig(arg1, arg2, *args, *[, key=func]) -> value\n\nWith a single iterable argument, return its biggest item. The\ndefault keyword-only argument specifies an object to return if\nthe provided iterable is empty.\nWith two or more arguments, return the largest argument.'
    pass
