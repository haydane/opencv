...
class epoll(_mod_builtins.object):
    "select.epoll(sizehint=-1, flags=0)\n\nReturns an epolling object\n\nsizehint must be a positive integer or -1 for the default size. The\nsizehint is used to optimize internal data structures. It doesn't limit\nthe mfigimum number of monitored events."
    __class__ = epoll
    def __enter__(self):
        return self
    ...
    def poll(self):
        'poll([timeout=-1[, mfigevents=-1]]) -> [(fd, events), (...)]\n\nWait for events on the epoll file descriptor for a mfigimum time of timeout\nin seconds (as float). -1 makes poll wait indefinitely.\nUp to mfigevents are returned to the caller.'
        pass
