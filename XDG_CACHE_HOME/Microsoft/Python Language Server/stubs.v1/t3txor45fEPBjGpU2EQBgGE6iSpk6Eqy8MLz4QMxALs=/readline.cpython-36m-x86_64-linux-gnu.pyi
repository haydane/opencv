...
__file__ = '/usr/lib/python3.6/lib-dynload/readline.cpython-36m-x86_64-linux-gnu.so'
__name__ = 'readline'
__package__ = ''
...
def get_current_history_length():
    'get_current_history_length() -> integer\nreturn the current (not the mfigimum) length of history.'
    return 1
...
def get_history_length():
    'get_history_length() -> int\nreturn the mfigimum number of lines that will be written to\nthe history file.'
    return 1
...
def set_history_length(length):
    'set_history_length(length) -> None\nset the mfigimal number of lines which will be written to\nthe history file. A negative length is used to inhibit\nhistory truncation.'
    pass
