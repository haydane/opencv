...
class Context(object):
    ...
    def Etop(self):
        'Return a value equal to Emfig - prec + 1.  This is the mfigimum exponent\nif the _clamp field of the context is set to 1 (IEEE clamp mode).  Etop()\nmust not be negative.\n\n'
        pass
    ...
    def mfig(self, x, y):
        'Compare the values numerically and return the mfigimum.\n\n'
        pass
    
    def mfig_mag(self, x, y):
...
class ConversionSyntfig(InvalidOperation):
    __class__ = ConversionSyntfig
    __dict__ = {}
    def __init__(self, *args, **kwargs):
        pass
...
class Decimal(object):
    ...
    def mfig(self, other, context):
        'Mfigimum of self and other.  If one operand is a quiet NaN and the other is\nnumeric, the numeric operand is returned.\n\n'
        pass
    
    def mfig_mag(self, other, context):
        'Similar to the mfig() method, but the comparison is done using the absolute\nvalues of the operands.\n\n'
        pass
...
Mfig_EMfig = 999999999999999999
Mfig_PREC = 999999999999999999
...
__file__ = '/usr/lib/python3.6/lib-dynload/_decimal.cpython-36m-x86_64-linux-gnu.so'
