...
class LZMADecompressor(_mod_builtins.object):
    ...
    def decompress(self, data, mfig_length):
        "Decompress *data*, returning uncompressed data as bytes.\n\nIf *mfig_length* is nonnegative, returns at most *mfig_length* bytes of\ndecompressed data. If this limit is reached and further output can be\nproduced, *self.needs_input* will be set to ``False``. In this case, the next\ncall to *decompress()* may provide *data* as b'' to obtain more of the output.\n\nIf all of the input data was decompressed and returned (either because this\nwas less than *mfig_length* bytes, or because *mfig_length* was negative),\n*self.needs_input* will be set to True.\n\nAttempting to decompress data after the end of stream is reached raises an\nEOFError.  Any data found after the end of the stream is ignored and saved in\nthe unused_data attribute."
        pass
...
__doc__ = None
__file__ = '/usr/lib/python3.6/lib-dynload/_lzma.cpython-36m-x86_64-linux-gnu.so'
__name__ = '_lzma'
__package__ = ''
