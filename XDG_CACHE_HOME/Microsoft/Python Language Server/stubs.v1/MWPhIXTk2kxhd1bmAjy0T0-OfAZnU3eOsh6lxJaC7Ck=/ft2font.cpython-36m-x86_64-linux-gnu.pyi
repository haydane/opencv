...
class FT2Font(_mod_builtins.object):
    ...
    def get_sfnt_table(self, name):
        'get_sfnt_table(name)\n\nReturn one of the following SFNT tables: head, mfigp, OS/2, hhea, vhea, post, or pclt.\n'
        pass
    ...
    @property
    def mfig_advance_height(self):
        pass
    
    @property
    def mfig_advance_width(self):
        pass
...
VERTICAL = 32
__doc__ = None
__file__ = '/usr/lib/python3/dist-packages/matplotlib/ft2font.cpython-36m-x86_64-linux-gnu.so'
__freetype_build_type__ = 'system'
__freetype_version__ = '2.8.1'
